    ...
    <div class="container">
        ...
        <div class="financial-summary-container">
            <div class="financial-summary">
                ...
                <p><strong>Total:</strong> <?php echo number_format($order['total_amount'], 2); ?> ARS</p>
                <p><strong>Monto Prepago:</strong> <?php echo number_format($order['prepaid_amount'], 2); ?> ARS</p>
                <p><strong>Saldo:</strong> <?php echo number_format($order['balance'], 2); ?> ARS</p>
            </div>
            <div class="summary-image">
                <img src="/public/assets/img/Patron-clave.png" alt="Patrón clave">
            </div>
        </div>
