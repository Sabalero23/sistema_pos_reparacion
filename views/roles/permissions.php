...
$permissionsByCategory = [
    ...
    'Caja registradora' => ['cash_register_manage', 'cash_register_open', 'cash_register_close', 'cash_register_movement'],
    ...
    'Cuentas de clientes' => ['customer_accounts_view', 'customer_accounts_adjust'],
    ...
    'Visitas a Domicilio' => ['home_visits_view', 'home_visits_create', 'home_visits_edit', 'home_visits_delete', 'calendar_view'],
