...
--
-- Servidor: localhost
-- Tiempo de generación: 08-09-2024 a las 14:55:37
...
CREATE TABLE `customer_accounts` (
  ...
  `status` enum('al_dia','atrasada','cancelada') DEFAULT 'al_dia',
...
CREATE TABLE `installments` (
  ...
  `status` enum('pendiente','pagada','parcial') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendiente',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `late_fees`
--
...
(85, 'customer_accounts_add', 'Agregar Cuentas a Clientes'),
(86, 'home_visits_send_whatsapp', 'Enviar Whatsapp de Visitas');
...
(1, 'Términos', 1, '2024-08-20 19:13:54');
...
(1, 'Company', 'America/Argentina/Buenos_Aires', 'ARS', 'info@company.com', 20, '0.21', '/uploads/logo_1724901287.png');
...
(1, 'Administrador', 'admin@admin.com', '$2y$10$0Hay/tM2SC.TUiIJ3jCN5.bYCTzp3uxi4nXaPuUT8jkBE5a0kT7iC', 1, '2024-08-20 17:31:01');
...
(1, 1, 'Soy Administrador', 'Avellaneda', 'https://www.url.com', '2024-08-19 16:45:17');
...
--
-- AUTO_INCREMENT de la tabla `late_fees`
--
ALTER TABLE `late_fees`
...
--
ALTER TABLE `installments`
  ADD CONSTRAINT `installments_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `customer_accounts` (`id`) ON DELETE CASCADE;
...
--
-- Filtros para la tabla `late_fees`
--
ALTER TABLE `late_fees`
  ADD CONSTRAINT `late_fees_ibfk_1` FOREIGN KEY (`installment_id`) REFERENCES `installments` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`account_id`) REFERENCES `customer_accounts` (`id`);
